...
class StoreInformation extends StatefulWidget {
  final int index;
  StoreInformation({required this.index});
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        state.restaurants.data[widget.index].name,
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(state.restaurants.data[widget.index].avgScore),
                                      Spacer(),
                                      Container(
                                        width: 48,
                                        decoration: BoxDecoration(
